...
const sampleData = {
  ...
  dishes: [
    ...
    { "id": "almaza", "categoryId": "beers", "name": "Almaza", "variants": [{ "label": "Small", "price": 6 }, { "label": "Large", "price": 8 }], "currency": "USD", "image": "/seed/almaza.jpg", "available": true },
...
function generateSVGPlaceholder(dishName, category, width = 400, height = 300) {
  const colors = {
  ...
  const colorScheme = colors[category] || colors.starters;
