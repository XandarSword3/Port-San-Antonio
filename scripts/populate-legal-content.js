// Script to populate legal pages with real content
// This will make the content editable through the staff portal
...
console.log('Legal content ready for database insertion:');
console.log('- Privacy Policy:', legalContent.privacy.sections.length, 'sections');
console.log('- Terms of Service:', legalContent.terms.sections.length, 'sections'); 
console.log('- Accessibility:', legalContent.accessibility.sections.length, 'sections');

// Export for use with Supabase
